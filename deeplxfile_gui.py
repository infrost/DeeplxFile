...
Radiobutton(radio_frame, text="Playwright (兼容性好)", variable=translation_mode_var, value="playwright").pack(anchor='w')
Radiobutton(radio_frame, text="Deeplx (默认，速度快)", variable=translation_mode_var, value="deeplx").pack(anchor='w')
